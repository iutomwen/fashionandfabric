...
import { CategoryTableProps, Tables } from "@/utils/types";
import { createSubCategory, updateSubCategoryById } from "../actions";
...
export default function EditForm({
  ...
  function onSubmit(values: z.infer<typeof FormSchema>) {
    ...
    startTransition(async () => {
      const result = await updateSubCategoryById(subcategory.id, data);
