...
import { Box, Link, CssBaseline,Typography,Container,Tabs, Tab ,Breadcrumbs} from '@mui/material'
    ...
    <Box
      ...
      >
        ...
        >
          ...
          <NextLink href={`/app/${user?.user_roles[0].role}/${user?.id}`} passHref>
            <Link underline="hover" color="inherit">
          ...
          <Box sx={{ width: "100%" }}>
            <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
              ...
              >
                ...
                {user?.user_roles === `business` ? "" : (<Tab  label="Store Edit" {...a11yProps(1)} />)}
